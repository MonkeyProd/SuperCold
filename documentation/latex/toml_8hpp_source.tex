\hypertarget{toml_8hpp_source}{}\doxysection{toml.\+hpp}
\label{toml_8hpp_source}\index{external/toml.hpp@{external/toml.hpp}}
\mbox{\hyperlink{toml_8hpp}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 \textcolor{comment}{/*}}
\DoxyCodeLine{2 \textcolor{comment}{ * The MIT License (MIT)}}
\DoxyCodeLine{3 \textcolor{comment}{ *}}
\DoxyCodeLine{4 \textcolor{comment}{ * Copyright (c) 2017 Toru Niina}}
...
\DoxyCodeLine{24 }
\DoxyCodeLine{25 \textcolor{preprocessor}{\#ifndef TOML\_FOR\_MODERN\_CPP}}
\DoxyCodeLine{26 \textcolor{preprocessor}{\#define TOML\_FOR\_MODERN\_CPP}}
\DoxyCodeLine{27 }
\DoxyCodeLine{28 \textcolor{preprocessor}{\#define TOML11\_VERSION\_MAJOR 3}}
\DoxyCodeLine{29 \textcolor{preprocessor}{\#define TOML11\_VERSION\_MINOR 7}}
\DoxyCodeLine{30 \textcolor{preprocessor}{\#define TOML11\_VERSION\_PATCH 1}}
\DoxyCodeLine{31 }
\DoxyCodeLine{32 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{parser_8hpp}{toml/parser.hpp}}"{}}}
\DoxyCodeLine{33 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{literal_8hpp}{toml/literal.hpp}}"{}}}
\DoxyCodeLine{34 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{serializer_8hpp}{toml/serializer.hpp}}"{}}}
\DoxyCodeLine{35 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{get_8hpp}{toml/get.hpp}}"{}}}
\DoxyCodeLine{36 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{macros_8hpp}{toml/macros.hpp}}"{}}}
\DoxyCodeLine{37 }
\DoxyCodeLine{38 \textcolor{preprocessor}{\#endif}\textcolor{comment}{// TOML\_FOR\_MODERN\_CPP}}
