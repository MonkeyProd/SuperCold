...
TileMap::TileMap() : m_tileset(), m_tile_size(){};
TileMap::TileMap(const sf::Texture &tileset, const sf::Vector2u &tile_size)
...
std::vector<sf::Sprite> TileMap::get_spites() { return m_sprites; }